/**
 * Geometrie Bounty-Aufgaben basierend auf MUNDO-Inhalten
 *
...
/**
 * TRIGONOMETRIE - Bounty-Aufgaben für neue Unit u7 oder Erweiterung von u2
 */
export const TRIGONOMETRIE_BOUNTIES: Task[] = [
  {
    id: 'u7-bounty-einheitskreis',
    type: 'input',
    question: 'Einheitskreis: Punkt P liegt bei Winkel α = 30°.\n a) sin(30°) (auf 3 Dezimalstellen)?\n b) cos(30°) (auf 3 Dezimalstellen)?',
    correctAnswer: '0,500; 0,866',
    explanation: 'Am Einheitskreis entspricht die y-Koordinate dem Sinus, die x-Koordinate dem Cosinus. sin(30°)=0,5, cos(30°)=√3/2≈0,866.',
...
export const PYTHAGORAS_BOUNTIES: Task[] = [
  {
    ...
    type: 'input',
    question: 'Rechtwinkliges Dreieck: Hypotenuse c = 13 cm, Hypotenusenabschnitte p = 4 cm, q = 9 cm.\n a) Höhe h (Höhensatz)?\n b) Kathete a (Kathetensatz)?\n c) Kathete b (Kathetensatz)?',
    correctAnswer: '6 cm; ≈7,21 cm; ≈10,82 cm',
    explanation: 'Höhensatz: h² = p×q = 4×9 = 36 → h = 6 cm. Kathetensatz: a² = p×c = 4×13 = 52 → a ≈ 7,21 cm. b² = q×c = 9×13 = 117 → b ≈ 10,82 cm.',
    difficultyLevel: 'Schwer',
    multiInputFields: [
      {
        id: 'height',
  ...
  },
  {
    ...
    type: 'input',
    question: 'Dachfläche berechnen: Hausbreite 10 m, Firsthöhe 3 m über Traufe, Dachlänge 12 m.\n a) Länge einer Dachseite (auf 0,1 m gerundet)?\n b) Gesamte Dachfläche beider Seiten (auf ganze m² gerundet)?',
    correctAnswer: '≈5,83 m; ≈140 m²',
    explanation: 'Dachseite = √((10/2)² + 3²) = √(25+9) = √34 ≈ 5,83 m. Gesamtfläche = 2 × 5,83 × 12 ≈ 140 m².',
    difficultyLevel: 'Schwer',
    multiInputFields: [
      {
        id: 'side',
...
export const KOERPER_BOUNTIES: Task[] = [
  {
    ...
    type: 'input',
    question: 'Körper: Quader (10×8×6 cm) + Pyramide oben (Grundfläche 10×8 cm, Höhe 4 cm).\n a) Gesamtvolumen (cm³)?\n b) Gesamtoberfläche ohne Kontaktfläche (cm², auf ganze Zahl)?',
    correctAnswer: '≈587 cm³; ≈520 cm²',
    explanation: 'Volumen: Quader 480 + Pyramide (10×8×4)/3 ≈ 106,67 → ≈587 cm³. Oberfläche: Quader 376 + Pyramidenmantel ≈ 144 → ≈520 cm².',
    difficultyLevel: 'Schwer',
    multiInputFields: [
      {
        id: 'volume',
  ...
  },
  {
    ...
    type: 'input',
    question: 'Kegelstumpf: r₁ = 8 cm, r₂ = 4 cm, h = 10 cm.\n a) Volumen (π≈3,14, auf ganze cm³)?\n b) Mantelfläche (auf ganze cm²)?',
    correctAnswer: '≈1173 cm³; ≈314 cm²',
    explanation: 'V = (πh/3)(r₁² + r₁r₂ + r₂²) = (3,14×10/3)(64+32+16) ≈ 1173 cm³. Mantel = π(r₁+r₂)s mit s = √((8-4)²+10²) = √116 ≈ 10,77 → M ≈ 314 cm².',
    difficultyLevel: 'Schwer',
    multiInputFields: [
      {
        id: 'volume',
...
export const STRAHLENSATZ_BOUNTIES: Task[] = [
  {
    ...
    type: 'input',
    question: 'Baumhöhe bestimmen: Person 1,70 m hoch, Schatten 2,5 m. Baum-Schatten 10 m.\n a) Baumhöhe (auf 0,1 m gerundet)?\n b) Welcher Strahlensatz? (Erster/Zweiter)',
    correctAnswer: '6,8 m; Erster',
    explanation: 'h_Baum / h_Person = s_Baum / s_Person → h_Baum = (1,70 × 10) / 2,5 = 6,8 m. Erster Strahlensatz: Verhältnis der Strahlabschnitte.',
    difficultyLevel: 'Schwer',
    multiInputFields: [
      {
        id: 'height',
  ...
  },
  {
    ...
    type: 'input',
    question: 'Zwei Strahlen, zwei Geraden. Abschnitte: Strahl 1: 5 cm / 10 cm, Strahl 2: 6 cm / 12 cm.\n a) Verhältnis Strahl 1?\n b) Sind die Geraden parallel? (ja/nein)',
    correctAnswer: '0,5; ja',
    explanation: 'Verhältnis Strahl 1: 5/10 = 0,5. Verhältnis Strahl 2: 6/12 = 0,5. Da die Verhältnisse gleich sind, sind die Geraden parallel (Umkehrung des Strahlensatzes).',
    difficultyLevel: 'Schwer',
    multiInputFields: [
      {
        id: 'ratio',
...
/**
 * KONGRUENTE DREIECKE - Bounty-Aufgaben für u2 oder u5
 */
export const KONGRUENZ_BOUNTIES: Task[] = [
  {
    id: 'u2-bounty-kongruenz',
    type: 'input',
    question: 'Dreieck ABC: a=6 cm, b=8 cm, γ=90°. Dreieck DEF: d=6 cm, e=8 cm, ε=90°.\n a) Welcher Kongruenzsatz? (SSS/SWS/WSW/SSW)\n b) Sind die Dreiecke kongruent? (ja/nein)\n c) Begründung kurz?',
    correctAnswer: 'SWS; ja; zwei Seiten und eingeschlossener Winkel gleich',
    explanation: 'SWS-Satz: Zwei Seiten (a=d, b=e) und der eingeschlossene Winkel (γ=ε=90°) sind gleich → Dreiecke kongruent.',
    difficultyLevel: 'Schwer',
    multiInputFields: [
      {
        id: 'satz',
...
export const VIELEcke_BOUNTIES: Task[] = [
  {
    ...
    type: 'input',
    question: 'Regelmäßiges Achteck: Seitenlänge a = 6 cm.\n a) Umfang (cm)?\n b) Flächeninhalt? (Formel: A ≈ 4,83 × a², auf ganze cm² gerundet)',
    correctAnswer: '48 cm; 174 cm²',
...
/**
 * 3D-GEOMETRIE - Bounty-Aufgaben für neue Unit u8
 */
export const DREID_BOUNTIES: Task[] = [
  {
    id: 'u8-bounty-3d-abstand',
    type: 'input',
  ...
  {
    id: 'u8-bounty-schnitt-wuerfel',
    type: 'input',
    question: 'Würfel (Kante 8 cm) wird von einer Ebene geschnitten, die durch drei Eckpunkte geht.\n a) Welche Form hat der Schnitt? (Dreieck/Quadrat/Rechteck/Fünfeck)\n b) Umfang des Schnitts? (auf 0,1 cm gerundet)',
    correctAnswer: 'Dreieck; ≈33,9 cm',
    explanation: 'Schnitt durch drei Eckpunkte eines Würfels ergibt ein Dreieck. Seitenlänge = Raumdiagonale einer Seitenfläche = 8√2 ≈ 11,31 cm. Umfang = 3 × 11,31 ≈ 33,9 cm.',
    difficultyLevel: 'Schwer',
    multiInputFields: [
      {
        id: 'form',
...
/**
 * Alle neuen Bounty-Aufgaben kombiniert
 *
 ...
 *   u8: DREID_BOUNTIES,
 *   // oder erweitern:
 *   u2: [...existing, ...KONGRUENZ_BOUNTIES],
 *   u4: [...existing, ...KOERPER_BOUNTIES],
 *   u5: [...existing, ...STRAHLENSATZ_BOUNTIES],
 *   u6: [...existing, ...PYTHAGORAS_BOUNTIES],
