...
export const SHOP_ITEMS: ShopItem[] = [
  ...
  { id: 'vc_25', name: '25€ Amazon Gutschein', type: 'voucher', cost: 2500, value: '25', icon: '💰', description: 'Belohne dich selbst mit Shopping-Guthaben.', rarity: 'legendary' },
  { id: 'vc_50', name: '50€ Amazon Gutschein', type: 'voucher', cost: 5000, value: '50', icon: '💎', description: 'Der große Bonus für Mathe-Meister.', rarity: 'legendary' },
  { id: 'vc_100', name: '100€ Amazon Gutschein', type: 'voucher', cost: 10000, value: '100', icon: '👑', description: 'Die ultimative Belohnung. Du bist eine Legende!', rarity: 'legendary' }
];
