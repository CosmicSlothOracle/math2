...
export const SHOP_ITEMS: ShopItem[] = [
  ...
  { id: 'eff_rain', name: 'Matrix Rain', type: 'effect', cost: 250, value: 'rain', icon: '📟', description: 'Digitale Zahlen regnen von oben. Du siehst die Matrix.', rarity: 'rare' },
  { id: 'eff_storm', name: 'Electric Storm', type: 'effect', cost: 400, value: 'storm', icon: '🌩️', description: 'Deine Maus erzeugt Blitze und elektrische Entladungen.', rarity: 'epic' },

  // Tier 2 - Advanced Effects (500-750)
  { id: 'eff_dark', name: 'Void Protocol', type: 'effect', cost: 500, value: 'dark', icon: '🌑', description: 'Tauche ein in die Dunkelheit. Hexagonales Void-Grid.', rarity: 'epic' },
  { id: 'eff_neon', name: 'Neon Dreams', type: 'effect', cost: 550, value: 'neon', icon: '🔮', description: 'Pulsierendes Neon-Grid mit Regenbogen-Glow.', rarity: 'epic' },
  { id: 'eff_unicorn', name: 'Unicorn Magic', type: 'effect', cost: 600, value: 'unicorn', icon: '🦄', description: 'Magische Sterne, Herzen und Regenbögen folgen dir.', rarity: 'epic' },
  { id: 'eff_fire', name: 'Fire Blaze', type: 'effect', cost: 700, value: 'fire', icon: '🔥', description: 'Flammen lodern am Bildschirmrand. Funken folgen der Maus.', rarity: 'legendary' },
  { id: 'eff_rainbow', name: 'Chroma Aura', type: 'effect', cost: 750, value: 'rainbow', icon: '🌈', description: 'Regenbogen-Wellen und prismatische Ringe.', rarity: 'epic' },

  // Tier 3 - Premium Effects (800-1200)
  { id: 'eff_galaxy', name: 'Galaxy Mode', type: 'effect', cost: 800, value: 'galaxy', icon: '🌌', description: 'Sternenmeer mit Nebeln, Parallax-Effekt und Sternschnuppen.', rarity: 'legendary' },
  { id: 'eff_quantum', name: 'Quantum Afterimage', type: 'effect', cost: 1200, value: 'quantum', icon: '⚛️', description: 'Quantenverschränkung. Deine Bewegungen hinterlassen Spuren.', rarity: 'legendary' },

  // Tier 4 - Ultimate Effects (2000+)
  { id: 'eff_singularity', name: 'Singularity Engine', type: 'effect', cost: 2000, value: 'singularity', icon: '🕳️', description: 'Schwarzes Loch mit Gravitationsverzerrung. Partikel spiralen.', rarity: 'legendary' },
  { id: 'eff_horizon', name: 'Event Horizon UI', type: 'effect', cost: 2500, value: 'horizon', icon: '🛰️', description: 'Raumzeit-Verzerrungsgitter. Die UI biegt sich um dich.', rarity: 'legendary' },
